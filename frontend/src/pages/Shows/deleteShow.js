...
const DeleteShow = ({ user, isUserSignedIn }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.delete(baseURL + '/shows', { params: { showId: id } }).then(res => {
            setDeleted(true)
            setTimeout(() => {
                history.push('/shows')
            ...
            <div className="container">
                {!deleted &&
                    <>
                        ...
                        <button onClick={handleSubmit} className="btn btn-lg" style={{ marginRight: "30px", backgroundColor: "#131312", color: "#F5C419" }}>Yes</button>
