            ...
            <div className="container">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <input required value={rating} onChange={(e) => setRating(e.target.value)} type="text" className="form-control" placeholder="Enter values between 0 to 10 inclusive" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="rating">Review</label>
                        <input required value={review} onChange={(e) => setReview(e.target.value)} type="text" className="form-control" placeholder="Write few words about the movie" />
                    </div>
