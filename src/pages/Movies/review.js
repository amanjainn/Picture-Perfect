...
const Review = (props) => {
    ...
    return (
        ...
        >
            ...
            <h4
                style={{ fontFamily: "arial", fontWeight: "300", marginTop: "-10px" }}
            >
                {review}
            </h4>
            <div
            ...
            >
                <div>
                    ...
                    <h6>
                        Last updated :
                        <span className="text-muted" style={{ backgroundColor: "white" }}>
                ...
                {adminSigned && (
                    <div>
                        <Link to={`/movies/${movieId}/editReview/${reviewId}`}>
                            <button
                                className="btn  "
                                style={{
                                    width: "50px",
                        ...
                        <Link to={`/movies/${movieId}/deleteReview/${reviewId}`}>
                            <button
                                className="btn "
